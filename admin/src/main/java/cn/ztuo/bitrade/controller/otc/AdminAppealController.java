...
public class AdminAppealController extends BaseAdminController {
    ...
    public MessageResult pageQuery(
            PageModel pageModel,
            AppealScreen screen) {
        log.info("分页查找后台申诉Appeal={}",screen);
        ...
        if(!StringUtils.isEmpty(screen.getNegotiant())) {
            endSql.append(" and (c.real_name like '%" + screen.getNegotiant() + "%'")
                    .append(" or c.username like '%" + screen.getNegotiant() + "%')");
        }
        ...
        log.info("countHead={}",countHead.toString());
        log.info("headSqlBuilder={}",headSqlBuilder.toString());

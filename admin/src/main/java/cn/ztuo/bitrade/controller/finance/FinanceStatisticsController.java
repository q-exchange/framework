...
public class FinanceStatisticsController {
    ...
    public MessageResult getResult(
            ...
            String unit) {
        logger.info("法币/币币 types={},startDate={},endDate={},unit={}",types,startDate,endDate,unit);
        Assert.notNull(types, "type must not be null ");
        if (endDate == null) {
            endDate = DateUtil.getDate(new Date(), 0);
        }
    ...
    public MessageResult getFee(TransactionTypeEnum type
            ...
            , @JsonFormat(timezone = "GMT+8", pattern = "yyyy-MM-dd") Date endDate
            , String unit) {
        logger.info("手续费统计 types={},startDate={},endDate={},unit={}",type,startDate,endDate,unit);
    ...
    public MessageResult recharge(TransactionTypeEnum type
        ...
        logger.info("充币/提币总量统计 types={},startDate={},endDate={},unit={}",type,startDate,endDate);

...
public class IndexController {
    ...
    public MessageResult getYestodayStatisticsInfo(
        ...
        logger.info("getYestodayStatisticsInfo+startDate={},endDate={}",startDate,endDate);
        if(endDate == null){
    ...
    public MessageResult getMemberStatisticsChart(
        ...
        logger.info("getMemberStatisticsChart+startDate={},endDate={}",startDate,endDate);
    ...
    public MessageResult otcStatistics(
        ...
        logger.info("otcStatistics +startDate={},endDate={},unit={}",startDate,endDate,unit);
    ...
    public MessageResult exchangeStatistics(
        ...
        Assert.notNull(unit, "unit must not be null ......");
        logger.info("exchangeStatistics +startDate={},endDate={},unit={}",startDate,endDate,unit);
        if (endDate == null) {
            endDate = DateUtil.getDate(new Date(), 1);
        }
        logger.info("endDate={}",endDate);
    ...
    public MessageResult otcNumChart(
        ...
        logger.info("otcNumChart +startDate={},endDate={},units={}",startDate,endDate,units);
    ...
    public MessageResult exchangeNumStatistics(
            ...
            String baseSymbol,
            String[] coinSymbols){
        logger.info("exchangeNumStatistics +startDate={},endDate={},baseSymbol={},coinSymbols+{}",startDate,endDate,baseSymbol,coinSymbols);
        Assert.notNull(startDate,"startDate must not be null ......");

...
import cn.ztuo.bitrade.service.RateService;
...
public class MemberController extends BaseController {
    ...
    public MessageResult getExchangeFeeRate(@SessionAttribute(SESSION_MEMBER) AuthMember member) {
        log.info("----->根据用户id获取用户费率--->member={}", member);
        BigDecimal[] feeRates = rateService.getFeeRate(member.getId());
        return success(feeRates);
    }

...
//        }
    ...
    public MessageResult loginByPhoneVerificationCode(@RequestParam("phone")String phone, @RequestParam("code")String code,
                                                      HttpServletRequest request) throws Exception {
        Assert.notNull(code, messageSourceService.getMessage("VERIFICATION_CODE_INCORRECT"));
        String key = SysConstant.PHONE_LOGIN_PREFIX + phone;

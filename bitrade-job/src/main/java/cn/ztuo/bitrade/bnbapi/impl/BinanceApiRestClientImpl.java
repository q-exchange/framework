package cn.ztuo.bitrade.bnbapi.impl;

import cn.ztuo.bitrade.bnbapi.BinanceApiRestClient;
import cn.ztuo.bitrade.bnbapi.domain.account.*;
import cn.ztuo.bitrade.bnbapi.domain.account.request.OrderStatusRequest;
import cn.ztuo.bitrade.bnbapi.domain.market.*;
import cn.ztuo.bitrade.bnbapi.constant.BinanceApiConstants;
import cn.ztuo.bitrade.bnbapi.domain.account.request.AllOrdersRequest;
import cn.ztuo.bitrade.bnbapi.domain.account.request.CancelOrderRequest;
import cn.ztuo.bitrade.bnbapi.domain.account.request.OrderRequest;
import cn.ztuo.bitrade.bnbapi.domain.general.Asset;
import cn.ztuo.bitrade.bnbapi.domain.general.ExchangeInfo;

import java.util.List;

import static cn.ztuo.bitrade.bnbapi.impl.BinanceApiServiceGenerator.createService;
import static cn.ztuo.bitrade.bnbapi.impl.BinanceApiServiceGenerator.executeSync;

...
public class HeartBeatHandler {
	...
	public HawkResponseMessage.CommonResult heartBeat(long seqId, byte[] body, ChannelHandlerContext ctx) {
		logger.info("心跳请求seqId={},body={},ctx={}",seqId,new String(body),ctx);
		HawkResponseMessage.CommonResult result = HawkResponseMessage.CommonResult.newBuilder().setResultCode(NettyResponseCode.SUCCESS.getResponseCode())
				.setResultMsg("心跳建立连接").build();
